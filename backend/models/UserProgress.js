...
const userProgressSchema = new mongoose.Schema({
  ...
  quizProgress: {
    ...
    categoryStats: {
      finance: { totalScore: 0, attempts: 0, averageScore: 0 },
      technology: { totalScore: 0, attempts: 0, averageScore: 0 },
      health: { totalScore: 0, attempts: 0, averageScore: 0 },
      education: { totalScore: 0, attempts: 0, averageScore: 0 },
      entertainment: { totalScore: 0, attempts: 0, averageScore: 0 },
      sports: { totalScore: 0, attempts: 0, averageScore: 0 },
      science: { totalScore: 0, attempts: 0, averageScore: 0 },
      history: { totalScore: 0, attempts: 0, averageScore: 0 }
    },
    streak: {
      type: Number,
      default: 0
